...
def test_aws_optimization_accuracy():
    ...
    test_scenarios = [
        ...
        {
            "name": "MODERATE ISSUES SCENARIO", 
            "attendees": 1500,
            "gates": 3,
            "lifecycle_summary": {
                "entry_rush": {
                    "peak_congestion_percent": 65.2,
                    "avg_entry_time_mins": 15,
                    "max_wait_time_mins": 20,
                    "entry_success_rate": 45.8,
                    "wait_time_distribution": {"0-5min": 300, "5-10min": 600, "10-15min": 400, "15+min": 200},
                    "duration_steps": 100
                },
                "mid_event": {
                    "peak_congestion_percent": 52.1,
                    "avg_wait_time_mins": 8,
                    "entry_success_rate": 65.2,
                    "duration_steps": 200
                },
                "evacuation": {
                    "peak_congestion_percent": 72.5,
                    "evacuation_time_seconds": 280,
                    "entry_success_rate": 75.0,
                    "duration_steps": 150
                }
            }
        },
        {
            ...
            "lifecycle_summary": {
                "entry_rush": {
                    ...
                    "avg_entry_time_mins": 8,
                    "max_wait_time_mins": 12,
                    "entry_success_rate": 85.2,
                    "wait_time_distribution": {"0-5min": 600, "5-10min": 300, "10-15min": 80, "15+min": 20},
                    "duration_steps": 100
                },
                "mid_event": {
                    "peak_congestion_percent": 35.4,
                    "avg_wait_time_mins": 5,
                    "entry_success_rate": 92.1,
                    "duration_steps": 200
                },
                "evacuation": {
                    "peak_congestion_percent": 58.2,
                    "evacuation_time_seconds": 180,
                    "entry_success_rate": 95.0,
                    "duration_steps": 150
                }
            }
        }
...
def validate_recommendations(scenario, ai_result, source):
    ...
    # Check critical phase identification
    critical_phase = ai_result['critical_phase']
    max_congestion = max(
        entry_data['peak_congestion_percent'],
        scenario['lifecycle_summary']['mid_event']['peak_congestion_percent'],
        scenario['lifecycle_summary']['evacuation']['peak_congestion_percent']
    )
    
    if entry_data['peak_congestion_percent'] == max_congestion and critical_phase != 'entry_rush':
        issues.append(f"Entry has highest congestion but critical phase is {critical_phase}")
